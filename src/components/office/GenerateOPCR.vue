<template>
  <q-dialog v-model="showModal" persistent>
    <q-card class="my-card" style="width: 90vw; max-width: 1200px; border-radius: 12px;">
      ...
      <!-- filepath: c:\xampp\htdocs\PMS-2025\Performance-Management-System\src\components\office\GenerateOPCR.vue -->
      <!-- filepath: c:\xampp\htdocs\PMS-2025\Performance-Management-System\src\components\office\GenerateOPCR.vue -->
      ...
      <div style="overflow-y: auto; max-height: 70vh; padding: 8px;">
        <div class="preview-container" id="opcr-preview">
          ...
          <div class="header-with-logos">
            <div class="header-row row items-center justify-between">
              ...
              <div class="header-text-content text-center">
                <div class="text-bold" style="margin-bottom: 5px; font-size: 0.9rem;">Republic of the Philippines</div>
                <div class="text-bold" style="margin-bottom: 5px; font-size: 0.9rem;">Province of Davao del Norte</div>
                <div class="text-bold" style="font-size: 1.2rem; margin-bottom: 10px;">CITY OF TAGUM</div>
          ...
          <table class="opcr-table q-mt-md"
            ...
            <thead>
              <tr>
                <th rowspan="2" style="border: 1px solid black; width: 8%; text-align: center; vertical-align: middle;">
                  MFO</th>
                <th rowspan="2"
                  style="border: 1px solid black; width: 20%; text-align: center; vertical-align: middle;">
                  REQUIRED COMPETENCY &<br>PROFIENCY LEVEL
                </th>
                <th rowspan="2"
                  style="border: 1px solid black; width: 12%; text-align: center; vertical-align: middle;">SUCCESS
                  INDICATOR</th>
                <th rowspan="2"
                  style="border: 1px solid black; width: 10%; text-align: center; vertical-align: middle;">ALLOTED
                  BUDGET</th>
                <th rowspan="2"
                  style="border: 1px solid black; width: 10%; text-align: center; vertical-align: middle;">DIVISION/
                  INDIVIDUAL ACCOUNTABLE</th>
                <th rowspan="2"
                  style="border: 1px solid black; width: 12%; text-align: center; vertical-align: middle;">ACTUAL
                  ACCOMPLISHMENT</th>
                <th colspan="4"
                  style="border: 1px solid black; width: 12%; text-align: center; vertical-align: middle;">RATING</th>
                <th rowspan="2" style="border: 1px solid black; width: 8%; text-align: center; vertical-align: middle;">
                  PROFIENCY RESULT</th>
                <th rowspan="2" style="border: 1px solid black; width: 8%; text-align: center; vertical-align: middle;">
                  REMARKS</th>
              ...
              <tr>
                <th style="border: 1px solid black; width: 3%; text-align: center; vertical-align: middle;">Q</th>
                <th style="border: 1px solid black; width: 3%; text-align: center; vertical-align: middle;">E</th>
                <th style="border: 1px solid black; width: 3%; text-align: center; vertical-align: middle;">T</th>
                <th style="border: 1px solid black; width: 3%; text-align: center; vertical-align: middle;">A</th>
              </tr>
            </thead>
            ...
            <tbody>
              ...
              <tr>
                <td style="border: 1px solid black;"><b>Enhanced Competency of Workforce</b></td>
                ...
                <td style="text-align: center;">P 19,101,441.00 (Personal Services)</td>
                <td style="text-align: center;">ARPMID</td>
              ...
              <tr>
                <td style="border: 1px solid black;">
                  MFO 1<br><b>Recruitment, Selection and Placement</b>
                </td>
                <td>
                  1. Delivering Service Excellence (Superior)<br>
                  2. Exemplifying Integrity (Superior)<br>
                ...
                <td>7,474 Recruitment, Selection and Placement related documents/activities approved and signed without
              ...
              <tr>
                <td style="border: 1px solid black;">
                  MFO 2<br><b>Performance Management</b>
                </td>
                <td>
                  1. Delivering Service Excellence (Superior)<br>
                  2. Exemplifying Integrity (Superior)<br>
              ...
              <tr>
                <td style="border: 1px solid black;">
                  MFO 3<br><b>Employees Compensation and Benefits</b>
                </td>
                <td>
                  1. Delivering Service Excellence (Superior)<br>
                  2. Exemplifying Integrity (Superior)<br>
                ...
                <td>1,194 employees Compensation and Benefits related documents/activities approved and signed without
                  lapses before the schedule</td>
                <td style="text-align: center;">P 19,101,441.00 (Personal Services)</td>
                <td style="text-align: center;">BHRD, ARPMID</td>
              ...
              <tr>
                ...
                <td>80% of the total 24 hours required Health & Wellness activities attended without lapses on time</td>
                <td style="text-align: center;">P 19,750,511.00 (Personal Services)</td>
                <td style="text-align: center;">ASD, ARPMID, BHRDD</td>
                <td>24 hours required Health & Wellness activities attended without lapses before scheduled time</td>
                <td style="text-align: center;">5</td>
                <td style="text-align: center;">5</td>
                <td style="text-align: center;">5</td>
                <td style="text-align: center;">5</td>
              ...
              <!-- Daily Time Record -->
              <tr>
                <td><b>Daily Time Record (DTR)</b></td>
                <td>Not Applicable</td>
              ...
              <tr>
                <td><b>Monitoring and Coaching</b></td>
                <td>Not Applicable</td>
              ...
              <!-- OPCR -->
              <tr>
                <td><b>Office Performance Commitment & Review (OPCR)</b></td>
                <td>Not Applicable</td>
              ...
              <tr>
                <td><b>Personnel Mechanism Meetings</b></td>
                <td>Not Applicable</td>
                <td>10 Personnel Mechanism meetings administered without lapses as scheduled</td>
                <td style="text-align: center;">P50,000.00 (Program for Personnel Mechanisms)</td>
                <td style="text-align: center;">CHRMO</td>
                <td>10 Personnel Mechanism meetings administered without lapses as scheduled</td>
                <td style="text-align: center;">3</td>
                <td style="text-align: center;">5</td>
                <td style="text-align: center;">5</td>
                ...
                <td colspan="12" style="border: 1px solid black; padding: 0;">
                  ...
                  <table style="width: 100%; border-collapse: collapse; border-top: 1px solid black;">
                    <tbody>
                      ...
                      <!-- filepath: c:\xampp\htdocs\PMS-2025\Performance-Management-System\src\components\office\GenerateOPCR.vue -->
                      <tr>
                        <td style="border: 1px solid black; padding: 8px;"><b>Strategic Functions:</b></td>
                        <td style="border: 1px solid black; padding: 8px; text-align: center;"><b>5.00</b></td>
                        <td rowspan="5" style="border: 1px solid black;"></td>
                      </tr>
                      <tr>
                        <td style="border: 1px solid black; padding: 8px;"><b>Core Functions:</b></td>
                        <td style="border: 1px solid black; padding: 8px; text-align: center;"><b>3.72</b></td>
                      </tr>
                      <tr>
                        <td style="border: 1px solid black; padding: 8px;"><b>Support Functions:</b></td>
                        <td style="border: 1px solid black; padding: 8px; text-align: center;"><b>4.13</b></td>
                      </tr>
                      <tr>
                        <td style="border: 1px solid black; padding: 8px;"><b>Final Rating:</b></td>
                        <td style="border: 1px solid black; padding: 8px; text-align: center;"><b>4.19</b></td>
                      </tr>
                      <tr>
                        <td style="border: 1px solid black; padding: 8px;"><b>Adjectival</b></td>
              ...
              <!-- SIGNATORY SECTION - Updated Date column width -->
              <tr>
                <td colspan="12" style="border: 1px solid black; padding: 0;">
                  ...
                  <table style="width: 100%; border-collapse: collapse; border-top: 1px solid black;">
                    <tbody>
                      <tr>
                        <td style="border: 1px solid black; padding: 6px; border-right: none; width: 15%;"><b>Assessed
                            by:</b>
                        </td>
                        <td colspan="4" style="border: 1px solid black; border-left: none; width: 55%;"></td>
                        <td style="border: 1px solid black; padding: 6px; width: 15%;"><b>Final Rating by:</b></td>
                        <td style="border: 1px solid black; padding: 6px; width: 15%; text-align: center;"><b>Date</b>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td rowspan="2" style="border: 1px solid black; height: 80px; width: 35%;"></td>
                        <td rowspan="6" style="border: 1px solid black; width: 5%;"></td>
                        <td rowspan="6"
                      ...
                      <tr>
                        <td style="border: 1px solid black; height: 20px; text-align: center; border-right: none;">
                          Planning Office</td>
                        <td style="border: 1px solid black; height: 20px; text-align: center;">Performance Management
                          Team
                        </td>
                      </tr>
                    </tbody>
...
@media (max-width: 768px) {
  ...
  /* Adjust table for horizontal scrolling */
  #opcr-preview {
    overflow-x: auto;
  }
