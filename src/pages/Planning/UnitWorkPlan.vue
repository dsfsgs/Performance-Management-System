...
<template>
  <q-page padding>
    ...
    <div class="row items-center justify-between q-mb-sm">
      <div>
        <h6 class="text-h6 q-mb-xs">Planning Unit Work Plan</h6>
      </div>
...
import generateReport from 'src/components/planning/generateReport.vue'
import employee from 'src/components/planning/employee.vue'
